        ...
        <>
            <div id="index-banner" class="parallax-container">
                <div className="section no-pad-bot">
                    <div class="container">
                        <br /><br />
                        <h1 className="header center teal-text text-lighten-2">About Event</h1>
                        <div className="row center">
                            ...
                            <h6 className="header col s12 light">
                                We are inspired to see the hard work of the<br />
                                next generation of young African inventors<br />
